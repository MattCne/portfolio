...
class FosUserUser
{
     ...
     * Add group
     *
     * @param \Mcneude\PortfolioBundle\Entity\FosUserGroup $group
     * @return FosUserUser
     */
    public function addGroup(\Mcneude\PortfolioBundle\Entity\FosUserGroup $group)
    {
        $this->group[] = $group;
     ...
     * @param \Mcneude\PortfolioBundle\Entity\FosUserGroup $group
     */
    public function removeGroup(\Mcneude\PortfolioBundle\Entity\FosUserGroup $group)
    {
